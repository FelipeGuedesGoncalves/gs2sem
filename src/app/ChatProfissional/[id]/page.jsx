...
// Verifica se há um item chamado "loginprof" na sessionStorage
...
// após confirmar que existe uma sala no banco de dados com as informações daquele profissional, a aplicação irá ler todas as mensagens presentes no array da key mensagens

// preciso de uma constante que, pegue as mensagens anteriormente lidas e faça a distinção entre mensagens de cliente e mensagens de profissional da seguinte forma: toda mensagem que tiver id, conteúdo e email pertence a um cliente, logo, a div da mensagem na aplicação terá uma className="mensagemCliente" e apresentará o conteúdo da mensagem do cliente. E toda mensagem que tiver id, conteúdo e rm_profissional pertence a um profissional, logo, a div da mensagem na aplicação terá uma className="mensagemProfissional" e apresentará o conteúdo da mensagem do profissional

// a ordem das mensagens na aplicação será feito com base no número da id, portanto se a mensagem tiver id 1 ela é a primeira mensagem, se tem id 2 é a segunda mensagem e assim por diante

// posteriormente irei tratar sobre o envio de mensagens ao banco então por hora se preocupe em implementar o que eu pedi
        ...
        useEffect(() => {
            ...
            .then(salaEncontrada => {
                if (salaEncontrada) {
                    ...
                    setMensagens(salaEncontrada.mensagens);
        ...
        <main className='mainChat'>
            ...
            <div className="conversa">
                <div className='mensagens'>
                    {/* esta div utilizará .map para mostrar todas as mensagens*/}
                </div>
            </div>
